...
//	uint32_t IR_sample, Red_sample;
	...
	/* If new sample was generated by sensor, read and print by serial */
	MAX30102_Print_Samples();
//	PRINTF("%ld\n", millis());
//	MAX30102_Get_Sample(&IR_sample, &Red_sample);
//	if (MAX30102_Get_Sample(&IR_sample, &Red_sample))
//	{
//		sprintf(value, "%d;%d", IR_sample, Red_sample);
//		USART_Printf(value);
//		USART_Printf(newLine);
//	}
